...
<span class="line"><span style="color:#F8F8F2;">-rw-r----- root     root              u:object_r:rootfs:s0 fstab.qcom</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br></div></div><p>2.再看一下进程的安全性文本：</p><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki monokai"><code><span class="line"><span style="color:#F8F8F2;">u:r:init:s0                    root      1     0     /init</span></span>
...
<span class="line"><span style="color:#F8F8F2;">u:r:kernel:s0                  root      45    2     mpm</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br></div></div><p>如上所示,安全性本文主要用冒号分为三个字段,这三个字段的意义为:<br><strong>Identify:Role:Type[:Range]</strong><strong>身份识别:角色:类型</strong><br> 这三个字段的意义仔细的说明一下吧:<br><strong>身份识别 (Identify):</strong> 相当于账号方面的身份识别!主要的身份识别则有底下三种常见的类型:</p><ul><li>root:表示 root 的账号身份,如同上面的表格显示的是 root 家目录下的数据啊!</li><li>system_u:表示系统程序方面的识别,通常就是程序啰;</li><li>user_u:代表的是一般使用者账号相关的身份。</li></ul><p>你会发现身份识别中,除了 root 之外,其他的识别后面都会加上『 _u 』的字样呢! 这个身份识别重点再让我们了解该数据为何种身份所有哩~ 而系统上面大部分的数据都会是 system_u 或root 啦!至于如果是在 /home 底下的数据,那么大部分应该就会是 user_u .<br><strong>角色 (Role):</strong> 透过角色字段,我们可以知道这个数据是属于程序、档案资源还是代表使用者。一般的角色有:</p><ul><li>object_r:代表的是档案或目录等档案资源,这应该是最常见的啰;</li><li>system_r:代表的就是程序啦!不过,一般使用者也会被指定成为 system_r 喔!</li></ul><p>你也会发现角色的字段最后面使用『 _r 』来结尾!因为是 role 的意思嘛!<br><strong>类型 (Type) :(最重要!)</strong> 基本上,一个主体程序能不能读取到这个档案资源,与类型字段有关!而类型字段 在档案与程序的定义不太相同,分别是:</p><ul><li>type:在档案资源 (Object) 上面称为类型 (Type);</li><li>domain:在主体程序 (Subject) 则称为领域 (domain) 了!</li></ul><p>domain 需要与 type 搭配,则该程序才能够顺利的读取档案资源啦!<br><strong>级别(Range):</strong><br> 级别和SELinux为了满足军用和教育行业而设计的Multi-Level Security（MLS）机制有关。但是在Android中，因为只使用了S0所以这里不作更多的介绍。<br><strong>之间的关系如下图所示：</strong><br><img src="`+F+'" alt="关系"></p><h2 id="_5-selinxu为什么可以解决dac的问题" tabindex="-1">5.SElinxu为什么可以解决DAC的问题？ <a class="header-anchor" href="#_5-selinxu为什么可以解决dac的问题" aria-label="Permalink to &quot;5.SElinxu为什么可以解决DAC的问题？&quot;">​</a></h2><br>',15),g=n("br",null,null,-1),k=n("br",null,null,-1),j=n("br",null,null,-1),w=a(`<h2 id="_6-android中selinux的体现" tabindex="-1">6.Android中SElinux的体现 <a class="header-anchor" href="#_6-android中selinux的体现" aria-label="Permalink to &quot;6.Android中SElinux的体现&quot;">​</a></h2><h3 id="_6-1-android-中的安全性文本" tabindex="-1">6.1 Android 中的安全性文本 <a class="header-anchor" href="#_6-1-android-中的安全性文本" aria-label="Permalink to &quot;6.1 Android 中的安全性文本&quot;">​</a></h3><p><br>Android 中的安全性文本主要在这这个目录下：<code>external/sepolicy/</code> 这这个目录下执行<code>ls *_contexts</code>可以看到：</p><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki monokai"><code><span class="line"><span style="color:#F8F8F2;">file_contexts  genfs_contexts  initial_sid_contexts  port_contexts  property_contexts  seapp_contexts  service_contexts</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br></div></div><p>这些文件都是Android 中的安全性文本。 <br><strong>注意：</strong> 进程的安全性文本在那存放？ 进程的安全性文本一般会由.rc的文件指定，在程序启动时候作为进程信息一部分存在，这样我们在执行ps -Ｚ时才能看到。<br> 介绍一下各个文件的作用：</p><ul><li>file_contexts：主要是文件相关的</li><li>seapp_contexts：主要是ＡＰＰ相关的</li><li>property_contexts：主要是系统属性相关的</li><li>initial_sid_contexts：主要是配合initial_sids（也在external/sepolicy）使用的，主要是用来初始化Object的安全性文本，在相关资料中这个动作称为Security Labeling</li><li>port_contexts：主要是网络相关的</li><li>service_contexts：主要系统服务相关的</li><li>genfs_contexts：主要是一些特殊的文件相关 <br><strong>以file_contexts为例，内容如下(实在是太长了，以下是部分)：</strong><br>可以对照安全性本文的介绍看一下。 <br></li></ul><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki monokai"><code><span class="line"><span style="color:#F8F8F2;">###########################################</span></span>
...
<span class="line"><span style="color:#F8F8F2;">class unix_dgram_socket</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br></div></div><p>根据SELinux规范，Object Class类型由class关键字申明<br> 2.cat <code>external/sepolicy/access_vectors</code>可以看到如下信息：</p><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki monokai"><code><span class="line"><span style="color:#F8F8F2;">#</span></span>
